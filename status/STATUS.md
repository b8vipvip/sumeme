...
- **采集时间：** 2026-08-25T19:18:03+08:00
- **总体状态：** `healthy`
...
- 本地网关：`ok`
- 公网入口：`ok`
- 磁盘使用：`65.9%`，剩余 11.7 GiB
- 内存使用：`50.3%`，可用 1.8 GiB

## 容器服务

| 服务 | 状态 | 健康 | 说明 |
|---|---|---|---|
| ai-provider-proxy | running | healthy | Up 7 days (healthy) |
| letta | running | healthy | Up 7 days (healthy) |
| lobe | running | - | Up 7 days |
| memory-gateway | running | healthy | Up 7 days (healthy) |
| postgresql | running | healthy | Up 7 days (healthy) |
...
| sumeme-web | running | healthy | Up 7 days (healthy) |

## 最近工作流

| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-25T11:17:42Z |
| Publish project status | success | main | 2026-08-25T10:47:45Z |
| Publish project status | success | main | 2026-08-25T10:05:01Z |
| Publish project status | success | main | 2026-08-25T09:31:58Z |
| Publish project status | success | main | 2026-08-25T08:58:02Z |
| Publish project status | success | main | 2026-08-25T08:06:07Z |
| Publish project status | success | main | 2026-08-25T07:25:23Z |
| Publish project status | success | main | 2026-08-25T07:08:02Z |
