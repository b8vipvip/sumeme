...
- **采集时间：** 2026-08-19T16:24:39+08:00
- **总体状态：** `healthy`
...
- 本地网关：`ok`
- 公网入口：`ok`
- 磁盘使用：`63.6%`，剩余 12.6 GiB
- 内存使用：`36.1%`，可用 2.3 GiB

## 容器服务

| 服务 | 状态 | 健康 | 说明 |
|---|---|---|---|
| ai-provider-proxy | running | healthy | Up 28 hours (healthy) |
| letta | running | healthy | Up 28 hours (healthy) |
| lobe | running | - | Up 28 hours |
| memory-gateway | running | healthy | Up 28 hours (healthy) |
...
| rustfs | running | healthy | Up 28 hours (healthy) |
| searxng | running | - | Up 28 hours |
| sumeme-web | running | healthy | Up 28 hours (healthy) |

## 最近工作流

| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-19T08:24:16Z |
