...
- **采集时间：** 2026-08-19T03:55:23+08:00
- **总体状态：** `healthy`
...
- 内存使用：`56.0%`，可用 1.6 GiB

## 容器服务

| 服务 | 状态 | 健康 | 说明 |
|---|---|---|---|
| ai-provider-proxy | running | healthy | Up 15 hours (healthy) |
| letta | running | healthy | Up 15 hours (healthy) |
| lobe | running | - | Up 15 hours |
| memory-gateway | running | healthy | Up 15 hours (healthy) |
| postgresql | running | healthy | Up 15 hours (healthy) |
| qdrant | running | healthy | Up 15 hours (healthy) |
| redis | running | healthy | Up 15 hours (healthy) |
| rustfs | running | healthy | Up 15 hours (healthy) |
| searxng | running | - | Up 15 hours |
| sumeme-web | running | healthy | Up 15 hours (healthy) |

## 最近工作流

| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-18T19:55:07Z |
| Publish project status | success | main | 2026-08-18T19:37:57Z |
| Publish project status | success | main | 2026-08-18T19:05:18Z |
| Publish project status | success | main | 2026-08-18T18:55:31Z |
| Smoke production | success | main | 2026-08-18T18:54:56Z |
| Publish project status | success | main | 2026-08-18T18:22:55Z |
| Publish project status | success | main | 2026-08-18T17:51:21Z |
| Publish project status | success | main | 2026-08-18T17:19:51Z |
