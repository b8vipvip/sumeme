...
- **采集时间：** 2026-08-26T10:13:29+08:00
- **总体状态：** `healthy`
...
- 本地网关：`ok`
- 公网入口：`ok`
- 磁盘使用：`66.2%`，剩余 11.6 GiB
- 内存使用：`47.1%`，可用 1.9 GiB
...
| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-26T02:13:03Z |
...
| Publish project status | success | main | 2026-08-25T22:26:39Z |
