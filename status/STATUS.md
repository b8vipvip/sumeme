...
- **采集时间：** 2026-08-19T14:03:18+08:00
- **总体状态：** `healthy`
...
| 服务 | 状态 | 健康 | 说明 |
|---|---|---|---|
| ai-provider-proxy | running | healthy | Up 26 hours (healthy) |
| letta | running | healthy | Up 26 hours (healthy) |
| lobe | running | - | Up 26 hours |
| memory-gateway | running | healthy | Up 26 hours (healthy) |
...
| sumeme-web | running | healthy | Up 26 hours (healthy) |

## 最近工作流

| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-19T06:02:57Z |
