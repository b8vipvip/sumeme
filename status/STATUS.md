...
- **采集时间：** 2026-08-02T19:39:50+08:00
- **总体状态：** `healthy`
...
| 服务 | 状态 | 健康 | 说明 |
|---|---|---|---|
| ai-provider-proxy | running | healthy | Up 34 hours (healthy) |
| letta | running | healthy | Up 2 days (healthy) |
| lobe | running | - | Up 2 days |
| memory-gateway | running | healthy | Up 34 hours (healthy) |
...
| sumeme-web | running | healthy | Up 34 hours (healthy) |

## 最近工作流

| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-02T11:39:30Z |
