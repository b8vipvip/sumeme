...
- **采集时间：** 2026-08-19T07:35:16+08:00
- **总体状态：** `healthy`
...
- 本地网关：`ok`
- 公网入口：`ok`
- 磁盘使用：`65.5%`，剩余 11.8 GiB
- 内存使用：`56.8%`，可用 1.6 GiB

## 容器服务

| 服务 | 状态 | 健康 | 说明 |
|---|---|---|---|
| ai-provider-proxy | running | healthy | Up 19 hours (healthy) |
| letta | running | healthy | Up 19 hours (healthy) |
| lobe | running | - | Up 19 hours |
| memory-gateway | running | healthy | Up 19 hours (healthy) |
| postgresql | running | healthy | Up 19 hours (healthy) |
| qdrant | running | healthy | Up 19 hours (healthy) |
| redis | running | healthy | Up 19 hours (healthy) |
| rustfs | running | healthy | Up 19 hours (healthy) |
| searxng | running | - | Up 19 hours |
| sumeme-web | running | healthy | Up 19 hours (healthy) |

## 最近工作流

| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-18T23:34:58Z |
| Publish project status | success | main | 2026-08-18T23:13:20Z |
| Publish project status | success | main | 2026-08-18T22:47:46Z |
| Publish project status | success | main | 2026-08-18T22:23:22Z |
| Publish project status | success | main | 2026-08-18T21:59:14Z |
| Publish project status | success | main | 2026-08-18T21:45:13Z |
| Publish project status | success | main | 2026-08-18T21:23:26Z |
| Publish project status | success | main | 2026-08-18T20:58:55Z |
