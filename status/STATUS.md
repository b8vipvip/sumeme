...
- **采集时间：** 2026-08-19T08:53:29+08:00
- **总体状态：** `healthy`
...
| 服务 | 状态 | 健康 | 说明 |
|---|---|---|---|
| ai-provider-proxy | running | healthy | Up 20 hours (healthy) |
| letta | running | healthy | Up 20 hours (healthy) |
| lobe | running | - | Up 20 hours |
| memory-gateway | running | healthy | Up 20 hours (healthy) |
| postgresql | running | healthy | Up 20 hours (healthy) |
| qdrant | running | healthy | Up 20 hours (healthy) |
| redis | running | healthy | Up 20 hours (healthy) |
| rustfs | running | healthy | Up 20 hours (healthy) |
| searxng | running | - | Up 20 hours |
| sumeme-web | running | healthy | Up 20 hours (healthy) |

## 最近工作流

| 工作流 | 结果 | 分支 | 时间 |
|---|---|---|---|
| Publish project status | in_progress | main | 2026-08-19T00:53:09Z |
| Publish project status | success | main | 2026-08-18T23:56:53Z |
